      ...
      this.pdfPage.getAnnotations(parameters).then(function (annotations) {
        ...
        if (self.div) {
          ...
          if (annotations.length === 0) {
            // CLASSIC: every page has to have an annotationLayer.
            //return;
          }
    ...
    scrollPageIntoView: function PDFViewer_scrollPageIntoView(pageNumber,
      ...
      switch (dest[1].name) {
        ...
        case 'Classic':
          ...
          y = dest[3];
          scale = dest[4];
          // If x and/or y coordinates are not supplied, default to _top_ of the page.
          x = x !== null ? x : this._location.left;
...
var HOSTED_VIEWER_ORIGINS = ['null',
  'http://mozilla.github.io', 'https://mozilla.github.io', 'http://student-dp8.intec.ugent.be'];
function validateFileURL(file) {
  try {
    ...
    // CLASSIC: allow localhost for development reasons.
  if (fileOrigin !== viewerOrigin && viewerOrigin !== "http:\/\/localhost") {
...
document.addEventListener('pagerendered', function (e) {
  ...
  /**
  * CLASSIC: redraw the highlights on the canvas.
  */
  highlightUpdate();
...
// CLASSIC
// Multiple divs of a same highlight have the same effect when hovered.
$(function(){
    $(document).on('mouseenter', '.classicAnnotation', function(){
        var id = $(this).attr("commentId");
        $("div[commentId=" + id + "]").addClass("classicAnnotationHovered");
    });
    $(document).on('mouseleave', '.classicAnnotation', function(){
        var id = $(this).attr("commentId");
        $("div[commentId=" + id + "]").removeClass("classicAnnotationHovered");
    });
});