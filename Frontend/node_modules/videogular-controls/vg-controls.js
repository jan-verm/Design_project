        ...
        function ($templateCache) {
            ...
            $templateCache.put("vg-templates/vg-scrub-bar-cue-points",
                '<div class="cue-point-timeline">' +
                    '<div ng-repeat="cuePoint in vgCuePoints" class="cue-point" \n\
                        ng-show="cuePoint.params.cuepointVisible"\n\
                        ng-click="gototime(cuePoint.timeLapse.start)" \n\
                        popover-animation="true" \n\
                        uib-popover-template="dynamicPopover.popoverUrl" \n\
                        ng-mouseenter="show_popover(cuePoint)" \n\
                        ng-mouseleave = "hide_popover(cuePoint)" \n\
                        popover-hoverable= true \n\
                        popover-is-open="cuePoint.params.isPopoverVisible" \n\
                        popover-placement="bottom" \n\
                        ng-style="cuePoint.$$style"></div>' +
                '</div>');
        }
    ])
    .directive("vgScrubBarCuePoints", [ '$filter', '$location', '$anchorScroll',
        function ($filter, $location, $anchorScroll, $timeout) {
            return {
                restrict: "E",
                require: "^videogular",
                templateUrl: function (elem, attrs) {
                ...
                link: function (scope, elem, attr, API) {
                    ...
                    scope.dynamicPopover = {
                        popoverUrl : 'views/partials/popover_template.html',
                    };
                    
                    scope.getPopoverString = function(cuePoint) {
                        var str = "<strong>" + cuePoint.params.comment.username + " </strong>" + cuePoint.params.comment.body;
                        if (str.length > 72){
                            str = $filter('limitTo')(str, 72, 0) + "...";
                        }
                        return str;
                    };
                    
                    scope.gototime = function gototime(time) {
                        API.seekTime(time);
                    };
                    ...
                    scope.show_popover = function (cuePoint) {
                        cuePoint.params.isPopoverVisible = true;
                    };
                    scope.hide_popover = function (cuePoint) {
                        cuePoint.params.isPopoverVisible = false;
                    };
                    ...
                    scope.scrollTo = function(id) {
                        ...
                        setTimeout(function(){ document.getElementById(id).setAttribute("class", "panel-body comment"); }, 3000);
                    };
