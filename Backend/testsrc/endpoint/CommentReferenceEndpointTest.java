...
public class CommentReferenceEndpointTest {
    ...
    public void testGetVideoReferences() throws Exception {
    	mock.perform(get("/course/1/lecture/0/comment/1/videoref"))
    			.andExpect(status().isOk())
    ...
    public void testGetVideoReferencesNotFoundException() throws Exception {
    	mock.perform(get("/course/1/lecture/0/comment/0/videoref"))
            .andExpect(status().is4xxClientError());
    }
	
	@Test
	public void testGetCourseNotesReferences() throws Exception {
		mock.perform(get("/course/1/lecture/0/comment/1/coursenotesref"))
			.andExpect(status().isOk())
    ...
    public void testGetCourseNotesReferencesNotFoundException() throws Exception {
    	mock.perform(get("/course/1/lecture/0/comment/0/coursenotesref"))
            .andExpect(status().is4xxClientError());
    }
    ...
    public void testPostVideoReference() throws Exception {
        ...
        mock.perform(post("/course/1/lecture/0/comment/1/videoref")
        	.content(requestBody))
        	.andExpect(status().isOk());
    }
    ...
    public void testPostVideoReferenceNotFoundException() throws Exception {
        ...
        mock.perform(post("/course/1/lecture/0/comment/0/videoref")
        	.content(requestBody))
        	.andExpect(status().is4xxClientError());
    }
    ...
    public void testPostCourseNotesReference() throws Exception {
        ...
        mock.perform(post("/course/1/lecture/0/comment/1/coursenotesref")
        	.content(requestBody))
        	.andExpect(status().isOk());
    }
    ...
    public void testPostCourseNotesReferenceNotFoundException() throws Exception {
        ...
        mock.perform(post("/course/1/lecture/0/comment/0/coursenotesref")
        	.content(requestBody))
        	.andExpect(status().is4xxClientError());
    }
    ...
    public void testPatchVideoReference() throws Exception {
        ...
        mock.perform(patch("/course/1/lecture/0/comment/1/videoref/1")
        	.content(requestBody))
        	.andExpect(status().isOk());
    }
    ...
    public void testPatchVideoReferenceNotFoundException() throws Exception {
        ...
        mock.perform(patch("/course/1/lecture/0/comment/1/videoref/0")
        	.content(requestBody))
        	.andExpect(status().is4xxClientError());
    }
    ...
    public void testPatchCourseNotesReference() throws Exception {
    	...
    	mock.perform(patch("/course/1/lecture/0/comment/1/coursenotesref/1")
        	.content(requestBody))
        	.andExpect(status().isOk());
    }
    ...
    public void testPatchCourseNotesReferenceNotFoundException() throws Exception {
    	...
    	mock.perform(patch("/course/1/lecture/0/comment/1/coursenotesref/0")
        	.content(requestBody))
        	.andExpect(status().is4xxClientError());
    }
    @Test
    ...
    public void testDeleteVideoReference() throws Exception {
    	mock.perform(delete("/course/1/lecture/0/comment/1/videoref/1"))
        	.andExpect(status().isOk());
    }
    
    @Test
    public void testDeleteVideoReferenceNotFoundException() throws Exception {
    	mock.perform(delete("/course/1/lecture/0/comment/1/videoref/0"))
        	.andExpect(status().is4xxClientError());
    }
    
    @Test
    public void testDeleteCourseNotesReference() throws Exception {
    	mock.perform(delete("/course/1/lecture/0/comment/1/coursenotesref/1"))
        	.andExpect(status().isOk());
    }
	
    @Test
    public void testDeleteCourseNotesReferenceNotFoundException() throws Exception {
    	mock.perform(delete("/course/1/lecture/0/comment/1/coursenotesref/0"))
        	.andExpect(status().is4xxClientError());
    }
}
