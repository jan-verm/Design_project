...
public class LTIControllerTest {
    ...
    public void setUp() throws ClassicDatabaseException {
        LTIMockUpDAO ltiMockup = new LTIMockUpDAO();
        ltiController = new LTIController(ltiMockup);
    }
    ...
    public void testGet() throws Exception {
        String secret = ltiController.getSecret("testclassic3");
        assertEquals(secret, "testclassic");
    }
